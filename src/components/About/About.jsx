    ...
    <section className="about section" id="about">
      <div className="about-container container">
          <div className="about-content">
            ...
            <p className="about-desc">Hello! I'm Mabior, a front-end developer with over three years of experience in the industry having a solid grasp of responsive design, delivering ideal user experience (UX) and user interface (UI).</p>
