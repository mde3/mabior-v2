  ...
  return (
    <header className={scrollHeader}>
      ...
      <nav className="nav container">
        <a href="#home" className="nav-logo">M<img src={logo} className="nav-logo-img" />D</a>
          <div className={active}>
            <ul onClick={removeNav} className="nav-list">
              ...
              <li className="nav-item"><a href="#projects" className="nav-link shadow">Projects</a></li>
            ...
            <div className="nav-footer">
              ...
              <div className="nav-footer-text-2"><p>mabior duom</p></div>
            </div>
          ...
          <a href="#contact" className="home-button button-header">Let's talk</a>
      </nav>
